...
require_once './../../../library/Zend/Db/Select.php';
...
abstract class Zend_Db_Table_Abstract
{
    ...
    public function getReference($tableClassname, $ruleKey = null)
    {
        ...
        if ($ruleKey !== null) {
            if (!isset($refMap[$ruleKey])) {
                ...
                require_once './../../../library/Zend/Db/Table/Exception.php';
    ...
    {
//        var_dump(file_exists('./../../../library/Zend/Registry.php'));
//        exit("bunda cabeluda".$db);
        if ($db === null) {            
            return null;
        }
