...
//var_dump(file_exists('./../../../library/Zend/Db.php'));
        ...
        if (array_key_exists(Zend_Db::CASE_FOLDING, $options)) {
            ...
            switch ($case) {
                ...
                case Zend_Db::CASE_NATURAL:
                    ...
                    break;
                default:
                    exit('buceta Abstract.php default');
                    /** @see Zend_Db_Adapter_Exception */
                    require_once './../../../library/Zend/Db/Adapter/Exception.php';
    ...
    public function setProfiler($profiler)
    {
        ...
        if ($profilerIsObject = is_object($profiler)) {
            if ($profiler instanceof Zend_Db_Profiler) {
                ...
                require_once './../../../library/Zend/Db/Profiler/Exception.php';
...
exit('buceta Abstract.php xxt');
    ...
    public function quoteInto($text, $value, $type = null, $count = null)
    {
    	...
    	$dd = explode(" ", $text);
    	$resto = "";
    	for($i = 1; $i < count($dd); $i++) $resto .= " ".$dd[$i];
    	
    	if(strpos($dd[0], ".")){
    		$var = explode(".", $dd[0]);
    		$text = $var[0].'."'.$var[1].'" '.$resto;
    	}else{
    		$text = '"'.$dd[0].'" '.$resto;
    	}
