...
function Header(){
    ...
    $logomarca = '../../sca/img/logo/'.$_SESSION['in_logomarca_log'];
    $this->Image($logomarca,10,10,12,7);
    $this->SetFont('Times', null, 10);
    $this->Text(140, 15, iconv('utf-8', 'iso-8859-1', dataExtenso('Goiânia', 'now')));
    $this->Ln(20);
}
