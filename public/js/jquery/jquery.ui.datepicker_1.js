...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		//prevText: '<img src='+'./public/img/setaesquerda.png'+' />', // Display text for previous month link
		//nextText: '<img src='+'./public/img/setadireita.png'+' align='+'right'+' />', // Display text for next month link
		...
		dayNames: ['Domingo', 'Segunda-feira', 'Ter&ccedil;a-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-feira', 'S&aacute;bado'], // For formatting
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var dayNamesMin = this._get(inst, 'dayNamesShort'); //dayNamesMin
